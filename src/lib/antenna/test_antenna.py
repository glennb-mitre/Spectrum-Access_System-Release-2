...
def test_standard_gain():
    # Isotropic antenna
    gains = antenna.GetStandardAntennaGains([0, 90, 180, 270],
                                            0, None, 5)
    assert np.max(np.abs(gains - 5 * np.ones(4))) == 0
    gains = antenna.GetStandardAntennaGains([0, 90, 180, 270],
                                            None, 90, 5)
    assert np.max(np.abs(gains - 5 * np.ones(4))) == 0
    gains = antenna.GetStandardAntennaGains([0, 90, 180, 270],
