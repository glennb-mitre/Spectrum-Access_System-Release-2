...
def _processDump(sas, dump, ssl_cert=None, ssl_key=None):
  ...
  for dump_file in dump['files']:
    ...
    """ dump_data[dump_file['recordType']].extend(json.loads(json.dumps({'files': [
      {'url': '/home/rrahman/winnf/Sas-Rel2-forked/Spectrum-Access_System-Release-2/schema/empty_activity_dump_file.json',
       'checksum': 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 'size': 19,
       'version': 'v1.3', 'recordType': "cbsd"},
      {
        'url': '/home/rrahman/winnf/Sas-Rel2-forked/Spectrum-Access_System-Release-2/schema/empty_activity_dump_file.json',
        'checksum': 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 'size': 19,
        'version': 'v1.3', 'recordType': "zone"},
      {
        'url': '/home/rrahman/winnf/Sas-Rel2-forked/Spectrum-Access_System-Release-2/schema/empty_activity_dump_file.json',
        'checksum': 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 'size': 19,
        'version': 'v1.3', 'recordType': "esc_sensor"},
      {
        'url': '/home/rrahman/winnf/Sas-Rel2-forked/Spectrum-Access_System-Release-2/schema/empty_activity_dump_file.json',
        'checksum': 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 'size': 19,
        'version': 'v1.3', 'recordType': "coordination"}
    ],
